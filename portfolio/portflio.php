...
<div class="row justify-content-center">
    <div class="col-md-10">
        <ul class="navigation nav nav-tabs">
            <li class="nav-item">
                <a class="navigation__individual nav-link <?php if ($link === 'individual') echo 'active' ?>" style="cursor: pointer">Индивидуальная</a>
            </li>
            <li class="nav-item">
                <a class="navigation__pair nav-link <?php if ($link === 'pair') echo 'active' ?>" style="cursor: pointer">Парная</a>
            </li>
            <li class="nav-item">
                <a class="navigation__beauty nav-link <?php if ($link === 'beauty') echo 'active' ?>" style="cursor: pointer">Бьюти</a>
            </li>
            <li class="nav-item">
                <a class="navigation__retouch nav-link <?php if ($link === 'retouch') echo 'active' ?>" style="cursor: pointer">Ретушь</a>
            </li>
        </ul>
    </div>
</div>
